...
{
    public class AskNewsViewModel : NewsViewModel
    {
        public AskNewsViewModel(IMvxNavigationService navigation
        ...
        protected override StoryKind StoryKind { get; } = StoryKind.Ask;
    }
}
